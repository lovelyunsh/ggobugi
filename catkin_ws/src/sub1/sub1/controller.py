...
# controller 노드는 시뮬레이터로부터 데이터를 수신해서 확인(출력)하고, 송신해서 제어가 되는지 확인해보는 통신 테스트를 위한 노드입니다.
...
class Controller(Node):
    ...
    def timer_callback(self):
        ...
        print('linear :',self.turtlebot_status_msg.twist.linear.x)
        print('angular :',self.turtlebot_status_msg.twist.angular.z)
        print('battery status :',self.turtlebot_status_msg.battery_percentage)
        print('charge status :',self.turtlebot_status_msg.power_supply_status)
        print('-------------------------------------------------------------------')
        print('environment')
        print('date :',self.envir_status_msg.month,'월',self.envir_status_msg.day,'일')
        print('time :',self.envir_status_msg.hour,'시',self.envir_status_msg.minute,'분')
        print('temperature :',self.envir_status_msg.temperature,'도')
        print('weather :',self.envir_status_msg.weather)
        print('-------------------------------------------------------------------')
        print('application :',*self.app_status_msg.data)
