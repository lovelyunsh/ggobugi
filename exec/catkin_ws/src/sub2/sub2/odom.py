...
# 로봇의 키네마틱스를 풀면 로봇의 선속도, 각속도를 이용해 로봇의 포즈를 추정할 수 있습니다.
# 또는 IMU로 부터 받은 Quaternion을 사용하거나 각속도, 가속도 데이터를 이용해서 로봇의 포즈를 추정할 수 있습니다.
# 다양한 방법을 이용해 오차가 가장 적은 방법으로 로봇의 포즈를 추정하세요.
    ...
    def listener_callback(self, msg):
        ...
        if self.is_imu == True:
            if self.is_status == False:
                ...
                # 로봇의 선속도, 각속도를 저장하는 변수, 시뮬레이터에서 주는 각속도는 방향이 반대이므로 (-)를 붙여줍니다.
